package mx.edu.ittepic.ladm_u1_practica3_hanahernandez
...
//Boton asiganr
        btnAsignar.setOnClickListener {
           ...
           // AlertDialog.Builder(this).setTitle("Numeros: ").setMessage("pos"+p+"valor"+v).show()
            for (i in 0..9){
                arreglo[p] = v
                numeros += ","+arreglo[i].toString()
                AlertDialog.Builder(this).setTitle("Numeros: ").setMessage("posicion"+i+"--"+numeros).show()
            }
